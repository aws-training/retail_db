...
) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' LOCATION 's3://retaildbbucket/orders';
...
) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' LOCATION 's3://retaildbbucket/order_items';
...
) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' LOCATION 's3://retaildbbucket/products';


CREATE TABLE daily_product_revenue ( order_date TIMESTAMP, product_name STRING,
revenue FLOAT
) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' LOCATION 's3://retaildbbucket/daily_product_revenue';
